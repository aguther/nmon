...
nmon_power_ubuntu140403_gpu: $(FILE)
	gcc -o nmon_power_ubuntu140403_gpu $(FILE) $(CFLAGS) $(LDFLAGS) -D POWER -D KERNEL_2_6_18 -D NVIDIA_GPU
...
nmon_x86_sles113:  $(FILE)
	cc -o nmon_x86_sles113 $(FILE) $(CFLAGS) $(LDFLAGS)  -D KERNEL_2_6_18 -D X86
